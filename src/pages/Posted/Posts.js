  ...
  async function handledata(id) {
    ...
    profilesRef.once("value", (snapshot) => {
      snapshot.forEach((profileSnapshot) => {
        ...
        if (followers && Object.keys(followers).includes(useruid)) {
          ...
          const postsRef = app9.database().ref(`users/${useruid}/posts/`);
          ...
          <div>
            ...
            >
              <Avatar
                ...
                size="large"
                shape="circle"
                style={{ display: bg && "none ", marginTop: " -5px" }}
              />{" "}
              <button
                disabled={!user}
                className="bgpost"
                style={{
                  ...
                  borderRadius: "20px",
                  color: "gray",
                  border: props.dark ? "1px solid black" : "1px solid gray",
                  background: props.dark && "#141515",
                  display: bg && "none ",
                }}
                onClick={handleClick}
              >
